...
import net.chaselabs.Mo_Craftables.Items.tools.ItemPickaxeBase;
...
public class ItemPickaxePlastic extends ItemPickaxeBase {

	public ItemPickaxePlastic(IItemTier tier, String name, String displayName) {
